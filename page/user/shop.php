...
?>
      ...
      <div class="media mt-3 mb-3 pl-2">
        ...
        <div class="media-body pt-2">
          <h3 class="mt-0 d-none d-lg-block texbos"><?= $game['game_name']; ?> <font class="ml-2 mr-2">|</font> Points คงเหลือ <?= $points; ?> Points</h3>
          <h3 class="mt-0 d-block d-lg-none texbos"><?= $game['game_name']; ?><h5 class="mt-0 d-block d-lg-none">Points คงเหลือ <?= $points; ?> Points</h5></h3>
