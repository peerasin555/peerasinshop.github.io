    ...
    <?php
      if($loged == 1){
        ...
        if($page == 'home'){
          ...
          include('page/user/history.php');
        }elseif($page == 'topup'){
          include('page/user/pay.php'); 
        }elseif($page == 'shop'){
          include('page/user/shop.php'); 
        }elseif($page == 'gift'){
          include('page/user/gift.php'); 
        }elseif($page == 'item'){
        ...
        }elseif($page == 'ordersetting'){
          if($data_user['role'] == '779'){
            include('page/admin/order_config.php');
          }else{
            $page = 'home';
            include('page/welcome.php'); 
          }
        }elseif($page == 'itemsetting'){
          if($data_user['role'] == '779'){
            include('page/admin/item_config.php');
          }else{
            $page = 'home';
            include('page/welcome.php'); 
          }
